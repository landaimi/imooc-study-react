...
class App extends Component {
    ...
    componentDidMount(){
        ...
        console.log('stageW',stageW,'imgW',imgW,'imgH',imgH,'imgFigureDOM',imgFigureDOM);
        // 计算中心图片的位置点
    ...
    */
    ...
    render() {
        ...
        imageDatas.forEach((element,index)=>{ 
            ...
            imgItems.push(<Figures key={index} data={element} ref={'imgFigure' + index}  arrange={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} center={this.center(index)}/>);
            controllerItems.push(<ControllerUnit key={index} arrange={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} center={this.center(index)}/>);
        });
            
        return (
            <section className='stage' ref ='stage'>
                <section className='img-sec'>{imgItems}</section>
                <nav className='controller-nav'>{controllerItems}</nav>
            </section>
        );  
    }
}
